...
export default {
    ...
    watch: {
        selectedShop(newShop, oldShop) {
            // Проверяем, изменились ли данные на самом деле
            if (JSON.stringify(newShop) !== JSON.stringify(oldShop)) {
                let obj = { coords: newShop.coords, address: newShop.address, from: newShop.from, phone: newShop.phone };
    ...
    mounted() {
        this.initMeta();
        this.addListenerToShop();
    },
    inject: ['configs'],
    methods: {
        addListenerToShop() {
            // Устанавливаем начальное значение selectedShop из localStorage
            this.selectedShop = JSON.parse(localStorage.getItem('selectedShop'));
        ...
        initMeta() {
            ...
            useSeoMeta({ title: 'Мой магазин' })
            this.breadcrumbs = [{ ['Мой магазин']: '' }]
            this.aboutPage = {
                title: 'Мой магазин',
            }
        },
    ...
    <main class="main">
        ...
        <section class="my-shop container">
            ...
            <div class="selected-shop">
                <div class="text-with-icon mb-16">
                    ...
                    <div class="text-with-icon__text selected-shop__address-text">{{ selectedShop.address }}</div>
                </div>
            ...
            <div class="select-shop-region-item__block our-shops-item__block">
                <div class="select-shop-region-item__contacts our-shops-item__contacts">
                    ...
                    <div key="shop-phone0" class="select-shop-region-item-contact our-shops-item-contact"
                        v-if="selectedShop.phone">
                        <div class="select-shop-region-item-contact__label our-shops-item-contact__label">
                            Телефон
                        </div>
                    ...
                    <div class="select-shop-region-item-contact our-shops-item-contact"
                        v-if="selectedShop.whatsapp || selectedShop.telegram">
                        <div class="select-shop-region-item-contact__label our-shops-item-contact__label">
                            Чат в мессенджере
                        </div>
                        <div class="select-shop-region-item-contact__value our-shops-item-contact__value">
                            <div class="select-shop-region-item-contact__socials our-shops-item-contact__socials">
                                <div key="shop-socials0"
                                    ...
                                    <a v-if="shop.whatsapp" :href="selectedShop.whatsapp" target="_blank">
                                        <div>
                                ...
                                <div key="shop-socials1"
                                    class="select-shop-region-item-contact__social our-shops-item-contact__social">
                                    <a v-if="selectedShop.telegram" :href="selectedShop.telegram" target="_blank">
                                        <div>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
            ...
            <OurShops :only-widget="true" v-model="selectedShop" />
        </section>

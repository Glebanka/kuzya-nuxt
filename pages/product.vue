...
export default {
  ...
  async setup() {
    ...
    const data = ref({});
    const { data: cachedData } = useNuxtData(`product-${route.path}-data`);
    if (cachedData.value) {
      data.value = cachedData.value;
    } else {
      const { data: apiData } = await useAPI(`${route.path}`, {
...
<template>
          ...
          <div class="current-product__block-body">
            <div class="current-product__slider _swiper">
                ...
                <template v-if="imgs && imgs.length > 1">
                  <div class="current-product-previews__slider current-product-previews__list">
                    <div class="current-product-previews__wrapper swiper-wrapper">
                      <template v-for="(preview, indx) in imgs" :key="'preview-'+product.id+'-'+indx">
                        <div class="swiper-slide current-product-previews__item click-product-preview__js">
                  ...
                  <div class="current-product-previews__arrows">
                    <div class="current-product-previews__arrow previews-arrow__js slider-arrow slider-arrow__js top">
              ...
              <div class="current-product__slider-body gallery">
                ...
                <div
                  class="current-product__slider-pagination swiper-pagination slider-pagination slider-pagination__js"
        ...
        <div class="current-product__block anim-item" v-anim-scroll>
          ...
          <div class="current-product__row row-1 hidden">
            ...
            <div class="current-product-share">
              <div class="current-product-share__btn share-btn open-share-popup__js " data-title="Поделиться"
                data-link="http://kuzya.loc/">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div class="current-product__btns card-product__btns">
              <div class="current-product__quantity card-product__quantity quantity quantity__js">
                ...
                <div class="quantity__btn plus" @click="plusOneProduct">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.1 18.56V2H10.9V18.56H9.1ZM1.5 11.16V9.44H18.5V11.16H1.5Z" fill="#1D1D1D" />
                  </svg>
                </div>
              </div>
              <div
                class="current-product__btn card-product__btn btn btn-basket default-anim bg-yellow add-product-basket__js"
              ...
              <div class="current-product__icon card-product__icon product-compare__js">
                <svg class="comparisons" width="28" height="28" viewBox="0 0 28 28" fill="none"
                  ...
                  <path class="border"
                    ...
                    stroke="#1D1D1D" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <div class="current-product-installment hidden">
            <div class="current-product-installment__btn open-installment-popup__js">
              <div class="current-product-installment__icon">
                <svg width="68" height="20" viewBox="0 0 68 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="68" height="20" rx="4" fill="black" />
                  <g clip-path="url(#clip0_1008_2872)">
                    ...
                    <path
                      d="M51.1944 9.60607L49.0452 7.21646H47.7887V12.7492H49.1006V9.21922L51.0628 11.3106H51.3052L53.2337 9.21922V12.7492H54.5456V7.21646H53.2891L51.1944 9.60607Z"
                      fill="white" />
                    <path
                      d="M60.7955 7.21646L57.544 10.8126V7.21646H56.2321V12.7492H57.434L60.6855 9.15313V12.7492H61.9974V7.21646H60.7955Z"
                      fill="white" />
                    <path
                      d="M40.7227 9.24098C40.7227 10.1219 41.2044 10.8158 41.9438 11.1067L40.5573 12.7492H42.163L43.4243 11.255H44.7891V12.7492H46.101V7.21646H42.7611C41.5159 7.21646 40.7227 8.06834 40.7227 9.24098ZM44.7899 8.43504V10.0711H43.0044C42.4087 10.0711 42.0891 9.73905 42.0891 9.25226C42.0891 8.76548 42.4199 8.43343 43.0044 8.43343L44.7899 8.43504Z"
                      fill="white" />
                    <path
                      d="M34.6265 8.32302C34.5462 10.2258 34.1448 11.4541 33.3588 11.4541H33.1621V12.7823L33.3717 12.7936C34.9477 12.8814 35.8188 11.4984 35.9617 8.47776H38.0346V12.7492H39.3441V7.21646H34.6707L34.6265 8.32302Z"
                      fill="white" />
                    <path
                      d="M29.6882 7.13916C27.9139 7.13916 26.6374 8.36741 26.6374 9.98251C26.6374 11.6532 28.0263 12.838 29.6882 12.838C31.4192 12.838 32.764 11.5871 32.764 9.98251C32.764 8.37789 31.4192 7.13916 29.6882 7.13916ZM29.6882 11.5098C28.6855 11.5098 28.0022 10.857 28.0022 9.98251C28.0022 9.08631 28.6863 8.45123 29.6882 8.45123C30.6902 8.45123 31.3967 9.11532 31.3967 9.98251C31.3967 10.8497 30.6805 11.5098 29.6882 11.5098Z"
                      fill="white" />
                    <path
                      d="M25.2461 7.2269H20.616L20.5718 8.33345C20.506 9.9276 20.0901 11.4436 19.3041 11.4653L18.9404 11.4766V13.9998L20.2635 13.9971V12.75H24.8599V13.9971H26.1942V11.4653H25.2461V7.2269ZM23.9342 11.4653H21.1346C21.6083 10.7464 21.862 9.70597 21.9062 8.489H23.9342V11.4653Z"
                      fill="white" />
                  </g>
                  <defs>
                    <clipPath id="clip0_1008_2872">
                      <rect width="56" height="8" fill="white" transform="translate(6 6)" />
                    </clipPath>
                  </defs>
                </svg>
              </div>
              <div class="current-product-installment__label">
                4 платежа по 1 000 ₽
              </div>
              <div class="current-product-installment__arrow">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <mask id="mask0_1008_2878" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="16"
                    height="16">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M12.5 8L6.65782 2L5.31564 3.42335L9.81564 8L5.31564 12.5766L6.65782 14L12.5 8Z" fill="black" />
                  </mask>
                  <g mask="url(#mask0_1008_2878)">
                    <rect width="16" height="16" fill="#C7C9CC" />
                  </g>
                </svg>
              </div>
            </div>
            <div class="current-product-installment__banks">
              <div class="current-product-installment__bank">
              ...
              <div class="current-product-installment__bank">
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_513_57534" x1="28.1573" y1="19.0584" x2="39.6942" y2="19.0584"
                    ...
                    <linearGradient id="paint1_linear_513_57534" x1="28.1573" y1="19.0584" x2="39.6942" y2="19.0584"
                      gradientUnits="userSpaceOnUse">
                      <stop stop-color="#007940" />
                      <stop offset="0.2285" stop-color="#00873F" />
                      <stop offset="0.7433" stop-color="#40A737" />
                    ...
                    <linearGradient id="paint2_linear_513_57534" x1="28.1573" y1="19.0584" x2="39.6942" y2="19.0584"
                      gradientUnits="userSpaceOnUse">
                      <stop stop-color="#007940" />
                      <stop offset="0.2285" stop-color="#00873F" />
                      <stop offset="0.7433" stop-color="#40A737" />
                    ...
                    <linearGradient id="paint3_linear_513_57534" x1="2.33038" y1="21.0146" x2="14.0458" y2="21.0146"
                      gradientUnits="userSpaceOnUse">
                    ...
                    <linearGradient id="paint4_linear_513_57534" x1="15.1823" y1="21.0146" x2="26.5602" y2="21.0146"
                      gradientUnits="userSpaceOnUse">
              ...
              <div class="current-product-installment__bank">
                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_513_57535" x1="41.9995" y1="18.2372" x2="29.749" y2="18.2372"
                      gradientUnits="userSpaceOnUse">
              ...
              <div class="current-product-installment__bank">
                <svg width="65" height="42" viewBox="0 0 65 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_513_57536)">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                      d="M19.038 24.9082C18.4663 24.9096 17.907 24.7401 17.4305 24.4212C16.9543 24.1033 16.5824 23.6498 16.3618 23.1181C16.1416 22.5868 16.0831 22.0013 16.1939 21.4362C16.3047 20.8712 16.5797 20.3523 16.9839 19.9459C17.3883 19.5377 17.9034 19.2597 18.4642 19.1469C19.0249 19.0341 19.6062 19.0915 20.1346 19.312C20.663 19.5323 21.1152 19.905 21.4332 20.3835C21.8045 20.9422 21.9719 21.6138 21.9069 22.2834C21.8418 22.953 21.5484 23.579 21.0768 24.0541C20.5356 24.5997 19.8026 24.9068 19.038 24.9082ZM19.038 16C18.0352 15.9978 17.0478 16.2502 16.1668 16.7341C15.2871 17.2171 14.5421 17.9163 14.0009 18.7671C13.1847 20.0507 12.8846 21.6006 13.1619 23.1002C13.4393 24.5998 14.2731 25.9358 15.4931 26.8353C16.3022 27.4337 17.2475 27.8167 18.2417 27.9492C19.2359 28.0817 20.2472 27.9593 21.1823 27.5934C22.117 27.2287 22.9455 26.632 23.5915 25.8584C23.1973 26.5953 22.6277 27.213 21.9679 27.6012V27.9104H24.9866V21.969C24.9788 20.3841 24.3489 18.867 23.2351 17.7506C22.1189 16.6316 20.6107 16.0025 19.038 16ZM47.659 24.9668H43.7331V23.0193H47.5842C48.0658 23.0193 48.6277 23.4753 48.6277 23.9934C48.6277 24.369 48.3362 24.9668 47.659 24.9668ZM43.7331 19.0374L47.0299 19.0367C47.3871 19.0367 47.9777 19.408 47.9777 20.0017C47.9777 20.4753 47.5954 20.9857 46.9307 20.9857H43.7331V19.0374ZM50.3401 21.6407C51.0565 20.5466 51.1222 19.0501 50.468 17.9299C50.1436 17.3759 49.6828 16.9163 49.1302 16.5958C48.5765 16.2747 47.9501 16.1035 47.3116 16.0988L40.7145 16.0981V27.9104L48.0965 27.9061C50.412 27.9061 51.7044 25.9833 51.7044 24.3697C51.7044 22.8167 50.8265 22.0388 50.3401 21.6407ZM37.7294 20.4506C38.7204 23.14 38.7708 25.5795 38.7708 27.9111H35.7067C35.7067 26.02 35.641 24.2984 35.2475 22.7419C34.7205 20.6553 33.7385 19.1384 32.8264 19.1384C31.9143 19.1384 30.9323 20.656 30.4046 22.7419C30.0111 24.2984 29.9461 25.9748 29.9461 27.9111H26.882C26.882 25.7892 26.9324 23.14 27.9234 20.4506C28.8453 17.9454 30.571 16 32.8257 16C35.0804 16 36.8061 17.9454 37.7294 20.4506ZM8.83231 16.0974H11.8971V17.3419C11.8979 18.2357 11.7001 19.1183 11.3184 19.9247C10.9366 20.7317 10.3809 21.4422 9.69199 22.0043C10.3809 22.5665 10.9366 23.2773 11.3184 24.0845C11.7 24.8907 11.8977 25.773 11.8971 26.6666V27.9111H8.83231V26.3553C8.83231 25.5859 8.52828 24.8475 7.98731 24.304C7.4459 23.7593 6.7128 23.4534 5.94855 23.4534C5.1843 23.4534 4.4512 23.7593 3.90979 24.304C3.64228 24.573 3.42999 24.8926 3.28511 25.2446C3.14022 25.5966 3.06559 25.9741 3.06549 26.3553V27.9104H2.12603e-06V26.6666C-0.000724251 25.7728 0.197031 24.8902 0.578712 24.0838C0.960808 23.2768 1.51674 22.5663 2.20581 22.0043C1.51664 21.4421 0.9607 20.7313 0.578712 19.924C0.197009 19.1176 -0.000747996 18.235 2.12603e-06 17.3412V16.0974H3.06549V17.6532C3.06549 18.4226 3.36952 19.1603 3.90979 19.7045C4.4512 20.2492 5.1843 20.5551 5.94855 20.5551C6.7128 20.5551 7.4459 20.2492 7.98731 19.7045C8.25495 19.4356 8.46736 19.116 8.61237 18.7639C8.75738 18.4119 8.83212 18.0345 8.83231 17.6532V16.0974ZM58.8068 24.9082C58.2352 24.9099 57.6759 24.7406 57.1993 24.4219C56.8431 24.1849 56.5437 23.8707 56.3229 23.5021C56.102 23.1336 55.9653 22.72 55.9226 22.2913C55.8799 21.8627 55.9323 21.4299 56.076 21.0243C56.2197 20.6187 56.4511 20.2505 56.7534 19.9466C57.1583 19.5392 57.6734 19.2616 58.2339 19.1489C58.7945 19.0361 59.3755 19.0931 59.9041 19.3127C60.4325 19.5323 60.884 19.9057 61.202 20.3835C61.5734 20.9421 61.7411 21.6136 61.6763 22.2832C61.6116 22.9527 61.3184 23.5788 60.847 24.0541C60.3055 24.6001 59.5719 24.9072 58.8068 24.9082ZM64.7547 21.969C64.7461 20.5601 64.2453 19.1994 63.3408 18.1268C62.4342 17.0517 61.1825 16.3324 59.8042 16.0946C58.4254 15.8563 57.0075 16.1138 55.7973 16.8224C54.589 17.5295 53.666 18.6439 53.1903 19.9699C52.7153 21.294 52.7187 22.7451 53.2001 24.0668C53.6826 25.3904 54.6113 26.5 55.8231 27.201C57.0366 27.9028 58.4552 28.1529 59.8323 27.9076C61.2095 27.6623 62.4578 26.9372 63.3603 25.8584C62.9661 26.5953 62.3965 27.2137 61.7374 27.6012V27.9111H64.7554L64.7547 21.969Z"
                      fill="black" />
                  </g>
                  <defs>
                    <clipPath id="clip0_513_57536">
                      <rect width="65" height="12" fill="white" transform="translate(0 16)" />
                    </clipPath>
                  </defs>
                </svg>
              </div>
              <div class="current-product-installment__bank">
                <svg width="69" height="42" viewBox="0 0 69 42" fill="none" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g clip-path="url(#clip0_513_57539)">
                    <mask id="mask0_513_57539" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="8" y="19"
                      width="13" height="12">
                      <path
                    ...
                    <g mask="url(#mask0_513_57539)">
                      <mask id="mask1_513_57539" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="8" y="19"
                        width="14" height="13">
                    ...
                    <mask id="mask2_513_57539" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="1" y="10"
                      width="20" height="23">
                      <path
                    ...
                    <mask id="mask3_513_57539" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="8" y="19"
                      width="12" height="11">
                      <path
                    ...
                    <g mask="url(#mask3_513_57539)">
                      <mask id="mask4_513_57539" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="8" y="19"
                        width="13" height="12">
                  ...
                  <defs>
                    <pattern id="pattern0_513_57539" patternContentUnits="objectBoundingBox" width="1" height="1">
                      <use xlink:href="#image0_513_57539" transform="scale(0.0103093 0.0107527)" />
                    </pattern>
                    <pattern id="pattern1_513_57539" patternContentUnits="objectBoundingBox" width="1" height="1">
            ...
            <div class="current-product-installment__info">
              Доступна рассрочка 0-0-6 без переплат
            </div>
          </div>
          <div class="current-product-delivery hidden">
            <div class="current-product-delivery__list">
              <div class="current-product-delivery__item">
                <div class="current-product-delivery__icon">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2064_3395)">
                      <path
                        d="M17.9219 7.76875L16.3406 3.025C16.1375 2.4125 15.5656 2 14.9187 2H5.08125C4.43437 2 3.8625 2.4125 3.65937 3.025L2.07812 7.76875C2.02812 7.92188 2 8.08125 2 8.24375V16.5C2 17.3281 2.67188 18 3.5 18H16.5C17.3281 18 18 17.3281 18 16.5V8.24375C18 8.08125 17.975 7.92188 17.9219 7.76875ZM3 8.24375C3 8.19063 3.00937 8.1375 3.025 8.08437L4.60625 3.34063C4.675 3.1375 4.86562 3 5.08125 3H9.5V8.25H3V8.24375ZM17 16.5C17 16.775 16.775 17 16.5 17H3.5C3.225 17 3 16.775 3 16.5V9.25H17V16.5ZM17 8.25H10.5V3H14.9187C15.1344 3 15.325 3.1375 15.3938 3.34063L16.975 8.08437C16.9906 8.13437 17 8.1875 17 8.24375V8.25Z"
                        fill="#1D1D1D" stroke="#1D1D1D" stroke-width="0.03125" />
                    </g>
                    <defs>
                      <clipPath id="clip0_2064_3395">
                        <rect width="20" height="16" fill="white" transform="translate(0 2)" />
                      </clipPath>
                    </defs>
                  </svg>
                </div>
                <div class="current-product-delivery__label">
                  Самовывоз из г. Исилькуль, ул. Коммунистическая, 30 - бесплатно
                </div>
              </div>
              <div class="current-product-delivery__item">
                <div class="current-product-delivery__icon">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_513_57524)">
                      <path
                ...
                <div class="current-product-delivery__label">
                  Доставка от 14 рабочих дней
                </div>
              </div>
            </div>
          </div>
          <div class="current-product__all-characteristics" :class="{ 'hidden': characteristics.length === 0 }">
        ...
        <div class="fixed-product">
          <div class="fixed-product__container container">
            ...
            <div class="fixed-product__block block-2">
              ...
              <div class="fixed-product__btn card-product__btn btn btn-basket default-anim bg-yellow" v-anim-hover
                @click="handleCartBtn">
                <div class="default">В корзину</div>
                <div class="ques ques-add">Добавить?</div>
                <div class="ques ques-remove">Удалить?</div>
      ...
      <div class="current-about-product__container grey-container">
        <div class="current-about-product__tabs tabs" v-tabs>
          <div class="current-about-product__tab-head tab-head">
            <div class="">
              <div class="current-about-product__tab-item tab-item default-tab-item click-tab-item__js _active">
                Доставка
              </div>
            </div>
            <div class="">
            ...
            <div class="tab-body anim-item" v-anim-scroll>
              <div class="tab-item-block _active">
                <div class="tab-item-block__body">
                  <div class="current-about-product__content" v-html="configs['PRODUCT_INFO_DELIVERY']"></div>
                </div>
              </div>
            ...
            <div class="popup-all-characteristics-block__items" v-if="characteristics.length">
              <ul class="list-style-none">
                <template v-for="(characteristic, indx) in characteristics"
                  :key="'blockCharacteristic-'+product.id+'-'+indx">
  ...
  <div class="popup-installment popup">
    <div class="popup-installment__container popup__container center w600">
      <div class="popup-installment__title popup__title">Оплатите 25% от стоимости покупки</div>
      <div class="popup-installment__subtitle">Оставшиеся 3 части спишутся автоматически с шагом в две недели
      </div>
      <div class="popup-installment__content popup__content">
        <div class="popup-installment__list">
          <div class="popup-installment-item _active">
            <div class="popup-installment-item__day">Сегодня</div>
            <div class="popup-installment-item__price">1 000 ₽</div>
          </div>
          <div class="popup-installment-item">
            <div class="popup-installment-item__day">24 дек</div>
            <div class="popup-installment-item__price">1 000 ₽</div>
          </div>
          <div class="popup-installment-item">
            <div class="popup-installment-item__day">7 янв</div>
            <div class="popup-installment-item__price">1 000 ₽</div>
          </div>
          <div class="popup-installment-item">
            <div class="popup-installment-item__day">21 янв</div>
            <div class="popup-installment-item__price">1 000 ₽</div>
          </div>
        </div>
        <div class="popup-installment__btn">
          <a href="#">
            <span>Оплатить</span>
            <svg width="102" height="16" viewBox="0 0 102 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M18.3906 0.799805H15.988V12.9838H18.3906V0.799805Z" fill="white" />
              <path d="M13.228 1.48158H10.8253V13.6653H13.228V1.48158Z" fill="white" />
              <path d="M8.06533 2.24271H5.66266V14.4287H8.06533V2.24271Z" fill="white" />
              <path d="M2.90267 3.0123H0.5L0.500009 15.1998H2.90268L2.90267 3.0123Z" fill="white" />
              <path
                d="M81.8492 7.29102L77.9806 2.98973H75.7189V12.9487H78.0803V6.59469L81.6122 10.3592H82.0487L85.5199 6.59469V12.9487H87.8812V2.98973H85.6196L81.8492 7.29102Z"
                fill="white" />
              <path
                d="M99.1312 2.98973L93.2784 9.46271V2.98973H90.917V12.9487H93.0804L98.9332 6.47574V12.9487H101.295V2.98973H99.1312Z"
                fill="white" />
              <path
                d="M63 6.63386C63 8.21947 63.8671 9.46851 65.1981 9.99221L62.7023 12.9487H65.5926L67.8629 10.2591H70.3197V12.9487H72.681V2.98973H66.6693C64.4278 2.98973 63 4.52311 63 6.63386ZM70.3211 5.18317V8.12807H67.1071C66.0348 8.12807 65.4597 7.53039 65.4597 6.65417C65.4597 5.77795 66.0551 5.18027 67.1071 5.18027L70.3211 5.18317Z"
                fill="white" />
              <path
                d="M52.0269 4.98152C51.8824 8.4066 51.1599 10.6175 49.7451 10.6175H49.391V13.0082L49.7682 13.0285C52.605 13.1866 54.173 10.6972 54.4302 5.26006H58.1616V12.9487H60.5186V2.98973H52.1064L52.0269 4.98152Z"
                fill="white" />
              <path
                d="M43.138 2.85059C39.9443 2.85059 37.6465 5.06144 37.6465 7.96862C37.6465 10.9759 40.1466 13.1084 43.138 13.1084C46.2537 13.1084 48.6743 10.8569 48.6743 7.96862C48.6743 5.0803 46.2537 2.85059 43.138 2.85059ZM43.138 10.7177C41.333 10.7177 40.1032 9.54262 40.1032 7.96862C40.1032 6.35545 41.3345 5.21231 43.138 5.21231C44.9415 5.21231 46.2133 6.40768 46.2133 7.96862C46.2133 9.52956 44.9242 10.7177 43.138 10.7177Z"
                fill="white" />
              <path
                d="M35.1421 3.00851H26.808L26.7285 5.00031C26.61 7.86978 25.8614 10.5985 24.4466 10.6377L23.792 10.658V15.1997L26.1736 15.1949V12.9501H34.447V15.1949H36.8488V10.6377H35.1421V3.00851ZM32.7808 10.6377H27.7416C28.5942 9.34368 29.0508 7.47084 29.1303 5.2803H32.7808V10.6377Z"
                fill="white" />
            </svg>
          </a>
        </div>
        <div class="popup-installment__more">
          Подробнее о сервисе можно узнать на <a href="//dolyame.ru" target="_blank">dolyame.ru</a>
        </div>
      </div>
      <div class="popup-installment__close popup__close close-popup__js default-anim" v-anim-hover>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="#1D1D1D" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" />
        </svg>

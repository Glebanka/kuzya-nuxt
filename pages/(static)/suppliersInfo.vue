...
const { data } = await useGetData('/pages', {
    params: { url_page: '/postavshikam' },
    key: 'suppliers-info-page-data'
});
        ...
        <section class="">
            <div class="container default-content anim-item" :class="{ 'anim-item-active': isAnimActive }">
                ...
                <div class="contacts-departments__btns">
                    <a :href="`${useRuntimeConfig().public.imgBaseURL}/storage/${configs['CONTACT_PDF']}`"
                        target="_blank" class="contacts-departments__btn btn-border default-anim" v-anim-hover>
                        ...
                        <svg class="arrow" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 19.3252L17.3507 6.97666" stroke="#0078BE" stroke-width="2.3"

...
const rules = computed(() => ({
    ...
    delivery: {
        detailAddress: {
            ...
            date: {
                required: requiredIf(() => form.delivery.isDelivery),
            },
            time: {
                required: requiredIf(() => form.delivery.isDelivery),
            },
...
function init() {
    ...
    if (userAddress) {
        form.delivery.address = userAddress;
    }
...
function initGetParameters() {
    if (useRoute().query.installment && checkedTotalPrice > 3000 && checkedTotalPrice < 50000) {
                            ...
                            <div class="make-order-form-block">
                                ...
                                <div class="make-order-form__radiobtns form-radiobtns">
                                    ...
                                    <div class="form-item" :class="{ '_checked': form.delivery.isDelivery }">
                                        <input id="radio-3" name="btns2[]" type="radio" disabled
                                            :checked="form.delivery.isDelivery" v-model="form.delivery.isDelivery"
                                            @click="selectDelivery" class="form-radiobtn select-delivery__js">
                              ...
                              Это обязательное поле для заполнения
                                        ...
                                        <div class="order-form-subblock__row date-time-delivery">
                                            <div class="make-order-form__item maker-order-date form-item calendar"
                                                :class="{ 'has-success': (!v$.delivery.detailAddress.date.$error && form.delivery.detailAddress.date.length > 0), 'has-error': (v$.delivery.detailAddress.date.$error) }">
                                                <label for="" class="form-label">Дата доставки</label>
                                                <div class="form-item__body">
                                                    <input type="text" id="formtask-date_task"
                                                        class="vanilla-calendar__input make-order-form__input form-input"
                                                        readonly v-model="form.delivery.detailAddress.date"
                                            ...
                                            <div class="make-order-form__select form-item select-box select-time__js no-hidden-li"
                                                :class="{ 'has-success': (!v$.delivery.detailAddress.time.$error && form.delivery.detailAddress.time.length > 0), 'has-error': v$.delivery.detailAddress.time.$error, '_active': isActiveTimeSelect }"
                                                    ...
                                                    <div class="select-box__content">
                                                        <ul class="list-style-none select-box__list">
                                                            <template v-for="item in deliveryTimes">
                                                                <li v-if="item.isHidden !== 'hidden'"
                                                                    @click="selectTime(item.time)"><span>{{
                                                                        item.time
                                                                        }}</span></li>
                                                            </template>
                                                        </ul>
                                    ...
                                    <div v-if="false">
                                        ...
                                        <div class="form-item"
                                            ...
                                            <input id="radio-p-3" name="btns1[]"
                                                :checked="(form.pay[2].toLowerCase() === form.selectedPay.toLowerCase())"
                                                v-model.trim="form.selectedPay"
                                                value="Долями - оплата частями в два клика" type="radio"
                                                class="form-radiobtn">
                                            <label for="radio-p-3" class="form-check-label">
                                                ...
                                                <svg width="28" height="42" viewBox="0 0 28 42" fill="none"
                                                    ...
                                                    <path d="M19.4972 11.9908H16.0055V29.6971H19.4972V11.9908Z"
                                                        fill="black" />
                                                    <path d="M11.9945 13.0969H8.50275V30.8066H11.9945V13.0969Z"
                                                        fill="black" />
                                                    <path
                                                        d="M4.49174 14.2154H1L1.00001 31.9271H4.49175L4.49174 14.2154Z"
                                                        fill="black" />
                                                </svg>
                                            </label>
                                        </div>
                                        <div class="form-item"
                                            ...
                                            <input id="radio-p-4" name="btns1[]" type="radio"
                                                :checked="(form.pay[3].toLowerCase() === form.selectedPay.toLowerCase())"
                                                v-model.trim="form.selectedPay" value="Сплит - оплата частями"
                                                class="form-radiobtn">
                                                ...
                                                <svg width="69" height="42" viewBox="0 0 69 42" fill="none"
                                                    ...
                                                    <g clip-path="url(#clip0_513_57539)">
                                                        <mask id="mask0_513_57539" style="mask-type:luminance"
                                                            maskUnits="userSpaceOnUse" x="8" y="19" width="13"
                                                            height="12">
                                                            <path
                                                        ...
                                                        <g mask="url(#mask0_513_57539)">
                                                            <mask id="mask1_513_57539" style="mask-type:luminance"
                                                                maskUnits="userSpaceOnUse" x="8" y="19" width="14"
                                                                height="13">
                                                                <path
                                                                    d="M21.3654 19.1553H8.78223V31.5397H21.3654V19.1553Z"
                                                                    fill="white" />
                                                            </mask>
                                                        ...
                                                        <mask id="mask2_513_57539" style="mask-type:luminance"
                                                            maskUnits="userSpaceOnUse" x="1" y="10" width="20"
                                                            height="23">
                                                            <path
                                                        ...
                                                        <g mask="url(#mask2_513_57539)">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                d="M1.25488 10.2695H20.5173V32.5704H1.25488V10.2695Z"
                                                                fill="#199554" />
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        <mask id="mask3_513_57539" style="mask-type:luminance"
                                                            maskUnits="userSpaceOnUse" x="8" y="19" width="12"
                                                            height="11">
                                                            <path
                                                        ...
                                                        <g mask="url(#mask3_513_57539)">
                                                            <mask id="mask4_513_57539" style="mask-type:luminance"
                                                                ...
                                                                height="12">
                                                                <path
                                                                    d="M20.6893 19.1553H8.78223V30.8704H20.6893V19.1553Z"
                                                                    fill="white" />
                                                            </mask>
                                        ...
                                        <div class="form-item"
                                            ...
                                            <label for="radio-p-6" class="form-check-label">
                                                <span>Кредит</span>
                                                <img :src="`${useRuntimeConfig().public.imgBaseURL}/storage/pochta-bank.png`"
                                                    alt="">
                                                <img :src="`${useRuntimeConfig().public.imgBaseURL}/storage/otp-bank.svg`"
                                                    alt="">
                                                <img :src="`${useRuntimeConfig().public.imgBaseURL}/storage/rusfinans-bank.png`"
                                                    alt="">
                                                <img :src="`${useRuntimeConfig().public.imgBaseURL}/storage/renesans-bank.png`"
                                                    alt="">
                                            </label>
                                        </div>
                                    </div>
